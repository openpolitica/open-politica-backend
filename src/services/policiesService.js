...
const getPolicyResults = async (body) => {
  ...
  let queryPresidentes = "SELECT hoja_vida_id, id_nombres, id_apellido_paterno, id_apellido_materno, enlace_foto, cargo_id, org_politica_id FROM candidato WHERE cargo_nombre LIKE '%PRESIDENTE%'";
